...
public class EventListenerTests {
  ...
  public void registerRunnableTest() {
    TestableEventListener<Object> eventListener = new TestableEventListener<>();
    eventListener.applyMock();

    eventListener.register(() -> {
    });

    verify(eventListener.mockedCallbacks, times(1)).add(any(Runnable.class));
  }
  ...
  public void unregisterRunnableTest() {
    ...
    verify(eventListener.mockedCallbacks, times(1)).remove(any(Runnable.class));
  }
  ...
  public void registerConsumerTest() {
    ...
    verify(eventListener.mockedCallbacks, times(1)).add(any(Consumer.class));
  }
  ...
  public void unregisterConsumerTest() {
    ...
    verify(eventListener.mockedCallbacks, times(1)).remove(any(Consumer.class));
  }
  ...
  public void triggerConsumerTest() {
    TestableEventListener<String> eventListener = new TestableEventListener<>();
