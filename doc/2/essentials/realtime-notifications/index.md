...
With Kuzzle, you don't [subscribe](/sdk/java/2/core-classes/collection/subscribe) to a room or a topic but, instead, you subscribe to documents.
...
| ------------------ | ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------- | ----------------- |
| `document`         | [Document](/sdk/java/2/core-classes/document) | Content of the document or real-time message that generated the notification                               |                   |
